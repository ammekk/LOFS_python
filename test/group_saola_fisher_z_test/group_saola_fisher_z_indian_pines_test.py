...
# from test.util.scale_data import standard_scale_fast, min_max_scale_fast
...
# # String of class attribute breaking algo
#
# def main():
...
#                                                lambda a: int(a) + 1)
#
#     group_feature = group_features(feature_index, 25)
#
#     select_features, select_groups, time = saola_group_z_test(group_feature, data,
#                                                               class_attribute_idx, .01)
